/* ════════════════════════════════════════════════════════════
   ...
   iii. Index Rerum (⌘K / Ctrl K) — ícone de luneta à ESQUERDA da
        vela, no chrome
...
(function () {
  ...
  /* ══════════════════════════════════════════════════════════
     CONTEÚDO BILÍNGUE do Index Rerum.
  ...
  var INDEX_ENTRIES = [
    ...
    { pt: "Prancha IV — Sports Experience", en: "Plate IV — Sports Experience", locPt: "Prancha IV", locEn: "Plate IV",        go: { sel: ".plate", nth: 3 } },
  ...
  /* ══════════════════════════════════════════════════════════
     ...
     Injetado na .chrome-actions (renderizada pelo React). Como o
     toggle PT/EN re-renderiza o root, garantimos a presença e o
     rótulo de forma idempotente via onRootChange.
     ══════════════════════════════════════════════════════════ */

  /* Lupa — silhueta de tinta com vidro recortado, brilho e cabo torneado.
     Mesmo estilo do castiçal: fill currentColor + acentos em var(--paper).
     Por usar currentColor, herda hover (oxblood) e modo vela. */
  var LUNETA_SVG =
