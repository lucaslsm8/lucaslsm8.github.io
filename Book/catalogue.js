...
const CONTENT = {
  pt: {
    ...
    preface: {
      ...
      body: [[{img: {src: "S.png", alt: "S", className: "drop-cap"}}, "ou Lucas Schoenherr, designer de produto sênior, baseado no Brasil¹. Esta publicação reúne, num único volume, treze anos de prática em design — com notas sobre método, sistemas, interfaces para modelos de linguagem, e sobre as ", {
    ...
    apparatus: {
      ...
      cvSlip: {
        ...
        gloss: "Feuille volante, encartada pelo editor.",
  ...
  en: {
    ...
    preface: {
      ...
      body: [["I'm Lucas Schoenherr, senior product designer, based in Brazil¹. This publication gathers, in a single volume, thirteen years of design practice — with notes on method, systems, interfaces for language models, and on the ", {
    ...
    apparatus: {
      ...
      cvSlip: {
        ...
        contextNote: "vide infra",
        gloss: "Feuille volante, tipped in by the editor.",
        meta: ["PDF", "2 pp", "240 KB", "MMXXVI"],
        printCta: "Take leaf",
        cta: "Take a leaf",
...
function CursorGlyph() {
  ...
  useEffect(() => {
    ...
    if (!el) return;
    const onMove = e => {
      // Posiciona acima da lupa (raio 100px + gap 36px = 136px)
      el.style.left = e.clientX + "px";
      el.style.top  = e.clientY - 136 + "px";
    };
    const onOver = e => {
...
function Apparatus({
  ...
  React.createElement(Reveal, {
    ...
    React.createElement("div", { className: "ti-stage" },
      React.createElement("span", { className: "cv-slip-page-label" }, a.cvSlip.contextLabel),
      ...
      React.createElement("span", { className: "cv-slip-corner", "aria-hidden": "true" }),
      ...
      React.createElement("span", { className: "cv-slip-cta" },
        a.cvSlip.cta,
        React.createElement("span", { className: "cv-slip-arrow", "aria-hidden": "true" }, " →")
      )
      )
    )
  )
